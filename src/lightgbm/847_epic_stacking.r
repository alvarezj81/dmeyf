...
hs <- makeParamSet( 
         ...
         makeIntegerParam("max_bin",           lower=30L       , upper=1024L)
         
        )

campos_malos  <- c("ccajas_transacciones", "Master_mpagominimo", "internet", "mcaja_ahorro_dolares", "mpayroll", "matm_other", "tmobile_app", "cmobile_app_trx")   #aqui se deben cargar todos los campos culpables del Data Drifting

ksemilla_azar  <- 199  #Aqui poner la propia semilla
#------------------------------------------------------------------------------
