...
setwd("/media/juan/Extraible/Maestria/EyF" )  #establezco la carpeta donde voy a trabajar
...
campos_buenos  <- setdiff( colnames(dataset),
                           c("clase_ternaria", "clase01", "internet", "mcaja_ahorro_dolares", "mpayroll", "matm_other", "tmobile_app", "cmobile_app_trx"))
