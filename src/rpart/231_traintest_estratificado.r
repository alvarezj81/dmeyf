...
particionar( dataset, division=c(70,30), agrupa="clase_ternaria", seed= 293 )  #Cambiar por la primer semilla de cada uno !
...
pdf(file ="/media/juan/Extraible/Maestria/EyF/work//MiPrimerArbol_02.pdf", paper="usr" )
