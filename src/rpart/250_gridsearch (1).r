...
ksemillas  <- c(199,293,397,499,599) #reemplazar por las propias semillas
...
for( vcp in c( -1, 0) ) 
for( vmaxdepth in  c(5,6,7,8,9) )
for( vminsplit in  c(2,4, 8, 10, 15, 20, 30 ) )
for( vminbucket  in  unique( as.integer(c(5,  vminsplit/10, vminsplit/5, vminsplit/3, vminsplit/2 )) ) )
{
