...
modelo  <- rpart("clase_ternaria ~ . -internet -mcaja_ahorro_dolares -mpayroll -matm_other -tmobile_app -
                  cmobile_app_trx -ctrx_quarter -mcaja_ahorro -cpayroll_trx -mtarjeta_visa_consumo -ctarjeta_visa_transacciones -
                 mcomisiones_mantenimiento -ccomisiones_mantenimiento -ccomisiones_otras -Visa_msaldopesos -mcomisiones_otras",
                 data= dtrain,
                 xval= 0,
                 control= parametros )
